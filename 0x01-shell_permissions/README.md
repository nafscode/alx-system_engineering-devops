[0-iam_betty](https://github.com/nafscode/alx-system_engineering-devops/blob/master/0x01-shell_permissions/0-iam_betty): Create a script that switches the current user to the user betty.
